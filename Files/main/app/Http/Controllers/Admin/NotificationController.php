...
class NotificationController extends Controller
{
    ...
    function universalUpdate() {
        ...
        return toastBack('success', 'Universal notification settings update successfully');
    }
    ...
    function templateUpdate($id){
        ...
        return toastBack('success','Notification template updated successfully');
    }
    ...
    function emailUpdate() {
        ...
        return toastBack('success', 'Email settings updated success');
    }
    ...
    function testEmail() {
        ...
        if (session('mail_error')) return toastBack('error', session('mail_error'));

        return toastBack('success', 'Email sent to ' . $emailAddress . ' successfully');
    }
    ...
    function smsUpdate() {
        ...
        return toastBack('success', 'SMS settings updated success');
    }
    ...
    function testSMS() {
        ...
        if (session('sms_error')) return toastBack('error', session('sms_error'));

        return toastBack('success', 'SMS sent to ' . request('mobile') . 'successfully');
    }
}
